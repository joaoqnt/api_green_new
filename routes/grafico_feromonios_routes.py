...
feromonios_bp = Blueprint('feromonios', __name__, url_prefix='/api/<tenant_name>/grafico_feromonio')

@feromonios_bp.route("/status_feromonios", methods=['GET'])
def get_status_feromonios(tenant_name):
...
@feromonios_bp.route("/status_feromonios_mensal", methods=['GET'])
def get_status_feromonios_mensal(tenant_name):
